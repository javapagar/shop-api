...
class ProductCartController:
    ...
    def add_product_to_cart(self, uuid_product: str, uuid_cart: str) -> str:
        ...
        self.save_product_in_cart(uuid_cart, product_to_cart)

        product_saver = ProductSaver(self._product_repository)
        return product_saver.save(
    ...
    def delete_product_from_cart(self, uuid_product: str, uuid_cart: str) -> str:
        product_dict = self.search_product(uuid_product=uuid_product)
        product_dict = self.increase_quantity(product_dict=product_dict)
